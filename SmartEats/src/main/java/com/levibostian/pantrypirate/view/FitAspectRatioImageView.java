...
package com.levibostian.pantrypirate.view;
 ...
 */
public class FitAspectRatioImageView extends android.widget.ImageView {
	...
	public FitAspectRatioImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	public FitAspectRatioImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public FitAspectRatioImageView(Context context) {
		super(context);
	}
